...
<%
	...
	File file=new File(config.getServletContext().getRealPath("/upload")+"/"+fileName);
	new ThumbnailMaker(config.getServletContext().getRealPath("/upload")+"\\",fileName,fileExt);
	//thumbnail.makeThumbnail(file.getAbsolutePath(), fileName, fileExt, config);
